...
`evals/evals.json` 包含 14 个回归场景，除原有的素材、项目、领域和 Impact 路径外，还覆盖错误初始问题的修复、闭卷重建、新例预测、反例收缩、不强迫迁移的工程作品阅读，以及 DeepChat 全系统理解。`evals/frame-quality.md` 定义候选框准入、预留测试、理解检验与成文追溯的评估方法。
