...
2. **Evidence trace**: the change maps to `E` and one component of `f*`.
...
- **survey**: foreground positioning, entry path, or tradeoff for the stated goal. Do not turn representative examples into field-wide action advice.
